...
export const Posts = [
  ...
  },
  {
    ...
    author: "Jane Smith",
    minutes: 7,
    author_image: "https://source.unsplash.com/random/800x600?beauty",
    post_coverImage: "https://source.unsplash.com/random/800x600?beauty",
    verified: true,
    date_posted: "May 27",
    category: "Lifestyle",
  },
  ...
  },
  {
    ...
    author: "Emily Brown",
    minutes: 8,
    author_image: "https://source.unsplash.com/random/800x600?business",
    post_coverImage: "https://source.unsplash.com/random/800x600?business",
    verified: false,
    date_posted: "May 10",
    category: "Lifestyle",
  },
      ...
      <div className="featured__content">
        ...
        <div className="featured__posts">
          {postData.map((post, index) => (
            <Link
              href={`/blog/details/`}
              // as={`/blog/details/${encodeURIComponent(post.title)}`}
              key={index}
            >
              <div className="post">
                <img
